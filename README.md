...
3. Gathers and loops through Taiwanese election data, using equations to analyze how support for the two main political parties (Kuomintang/Chinese Nationalist Party and Democratic Progressive Party) has shifted over time. 
4. Generates graphs and charts illustrating these changes in political attitudes, voting and U.S. military spending so that they can be compared to each other, observing for any patterns that might be jumping off points for more rigorous study.
